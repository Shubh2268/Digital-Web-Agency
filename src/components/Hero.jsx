            ...
            <div className='max-w-7xl mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center gap-12'>
                ...
                <div className='w-full lg:w-1/2 text-center lg:text-left'>
                    ...
                    <div className='flex flex-col sm:flex-row gap-4 justify-center lg:justify-start'>
                        <a href='#contact' className='px-8 py-2 bg-[#1090CB] text-white rounded-md font-medium transition'>Contact Us</a>
                        <a href='#view' className='px-8 py-2 bg-transparent border-2 border-[#1090CB] text-[#1090CB] rounded-md font-medium transition'>View more</a>
                    </div>
                </div>
